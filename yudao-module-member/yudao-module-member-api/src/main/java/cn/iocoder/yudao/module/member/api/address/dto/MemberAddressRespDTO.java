...
public class MemberAddressRespDTO {
    ...
    @Schema(description = "收件人名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "宇擎")
    private String name;
    ...
    @Schema(description = "收件详细地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "项目团队 88 小区 106 号")
