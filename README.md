...
> 本项目基于 **Spring Cloud Alibaba + Gateway + Nacos + RocketMQ + Vue3 + Vben Admin** 构建，覆盖 OA、BPM、HRM、CRM、ERP、资产、仓储、商城、AI、IoT、报表等多个业务域，可作为企业管理平台的二次开发基础工程。
...
> 📖 更详细的部署文档请查看 [快速启动指南](https://example.com/quick-start/)
